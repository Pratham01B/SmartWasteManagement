 ...
 *
 * Note: The source file lives under entity/ but declares package com.smartwaste.model —
 * this test mirrors that declared package.
 */
class PasswordResetTokenTest {
    ...
    // -------------------------
    // Expiry logic (helper assertions — no custom method, but common usage pattern)
    // -------------------------
